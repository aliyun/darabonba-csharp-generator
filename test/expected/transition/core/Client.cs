...
namespace AlibabaCloud.OpenApiClient
{
    public class Client 
    {
        ...
        /// </description>
        public static Ecs20140526Client Initialization(string regionId)
        {
        ...
        {
            Ecs20140526Client client = Initialization("cn-hangzhou");
            Console.WriteLine("CreateSecurityGroup");
            CreateSecurityGroupResponseBody createSecurityGroupResponseBody = CreateSecurityGroup(client);
            ...
            AuthorizeSecurityGroupResponseBody authorizeSecurityGroupResponseBody = AuthorizeSecurityGroup(client, securityGroupId);
            ...
            RunInstancesResponseBody runInstancesResponseBody = CreateInstance(client, securityGroupId);
            ...
            bool? isWaitForInstancesRunningSuccess = WaitForInstancesRunning(client, instanceIds).Value;
            ...
            DescribeInstancesResponseBody describeInstancesResponseBody = LogInstancesInfo(client, instanceIds);
        ...
        /// </returns>
        public static CreateSecurityGroupResponseBody CreateSecurityGroup(Ecs20140526Client client)
        {
            try
            {
        ...
        /// </returns>
        public static AuthorizeSecurityGroupResponseBody AuthorizeSecurityGroup(Ecs20140526Client client, string securityGroupId)
        {
            try
            {
                ...
                AuthorizeSecurityGroupResponse response = client.AuthorizeSecurityGroup(request);
                return response.Body;
            }
            catch (TeaException error)
            {
        ...
        /// </returns>
        public static RunInstancesResponseBody CreateInstance(Ecs20140526Client client, string securityGroupId)
        {
            try
            {
        ...
        /// </returns>
        public static bool? WaitForInstancesRunning(Ecs20140526Client client, List<string> instanceIds)
        {
        ...
        /// </returns>
        public static DescribeInstancesResponseBody LogInstancesInfo(Ecs20140526Client client, List<string> instanceIds)
        {
            try
            {
                DescribeInstancesRequest request = new DescribeInstancesRequest

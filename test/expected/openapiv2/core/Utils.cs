...
namespace AlibabaCloud.OpenApiClient
{
    public class Utils 
    {
        ...
        /// void
        /// </returns>
        public static void Convert(Darabonba.Model body, Darabonba.Model content)
        {
        ...
        /// the signed string
        /// </returns>
        public static string GetStringToSign(Darabonba.Request request)
        {
            throw new NotImplementedException();
        }
        ...
        /// </returns>
        public static string GetAuthorization(Darabonba.Request request, string signatureAlgorithm, string payload, string accesskey, string accessKeySecret)
        {
            throw new NotImplementedException();
        }

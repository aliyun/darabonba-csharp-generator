...
namespace Darabonba.Test
{
    public class Client : SourceClient, IClient
    {
        ...
        public RuntimeObject Complex1(ComplexRequest request, SourceClient client)
        {
            request.Validate();
            client.Validate();
        ...
        public async Task<RuntimeObject> Complex1Async(ComplexRequest request, SourceClient client)
        {
            request.Validate();
            client.Validate();
            Dictionary<string, object}> runtime_ = new Dictionary<string, object>

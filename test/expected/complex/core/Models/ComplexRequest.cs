    ...
    public class ComplexRequest : DaraModel {
        ...
        public class ComplexRequestHeader : DaraModel {
            ...
            public class ComplexRequestHeaderListSub : DaraModel {
                ...
                {
                    DaraModel.ValidateRequired("listSubItemName", ListSubItem, true);
                    if (ListSubItemSub != null) {
                        ListSubItemSub.Validate();
                    }
                    DaraModel.ValidateRequired("listSubItemSubName", ListSubItemSub, true);
                    base.Validate();
                }
            ...
            public class ComplexRequestHeaderSubModel : DaraModel {
                ...
                public new void Validate()
                {
                    DaraModel.ValidateRequired("subModelStr", SubModelStr, true);
                    base.Validate();
                }
            ...
            public new void Validate()
            {
                DaraModel.ValidateRequired("Content", Content, true);
                if (ListSub is IList) {
                    DaraModel.ValidateArray(ListSub);
                }
                DaraModel.ValidateRequired("listSub", ListSub, true);
                if (ListStr is IList) {
                    DaraModel.ValidateArray(ListStr);
                }
                DaraModel.ValidateRequired("listStr", ListStr, true);
                if (SourceClient != null) {
                    SourceClient.Validate();
                }
                DaraModel.ValidateRequired("sourceClient", SourceClient, true);
                if (SourceConfig != null) {
                    SourceConfig.Validate();
                }
                DaraModel.ValidateRequired("sourceConfig", SourceConfig, true);
                if (SubModel != null) {
                    SubModel.Validate();
                }
                ...
                if (SubMutiArray is IList) {
                    DaraModel.ValidateArray(SubMutiArray);
                }
                DaraModel.ValidateRequired("subMutiArray", SubMutiArray, true);
                base.Validate();
            }
        ...
        public class ComplexRequestConfigs : DaraModel {
            ...
            public new void Validate()
            {
                DaraModel.ValidateRequired("key", Key, true);
                if (Value is IList) {
                    DaraModel.ValidateArray(Value);
                }
                DaraModel.ValidateRequired("value", Value, true);
                if (Extra is IDictionary) {
                    DaraModel.ValidateMap(Extra);
                }
                DaraModel.ValidateRequired("extra", Extra, true);
                base.Validate();
            }
        ...
        public new void Validate()
        {
            ...
            DaraModel.ValidateRequired("duplicatName", DuplicatName, true);
            DaraModel.ValidateRequired("accessKey", AccessKey, true);
            DaraModel.ValidateRequired("Body", Body, true);
            if (Strs is IList) {
                DaraModel.ValidateArray(Strs);
            }
            DaraModel.ValidateRequired("Strs", Strs, true);
            if (Header != null) {
                Header.Validate();
            }
            DaraModel.ValidateRequired("header", Header, true);
            DaraModel.ValidateRequired("num", Num, true);
            if (Client != null) {
                Client.Validate();
            }
            DaraModel.ValidateRequired("client", Client, true);
            if (Part is IList) {
                DaraModel.ValidateArray(Part);
            }
            if (Configs != null) {
                Configs.Validate();
            }
            DaraModel.ValidateRequired("configs", Configs, true);
            if (Dict is IDictionary) {
                DaraModel.ValidateMap(Dict);
            }
            DaraModel.ValidateRequired("dict", Dict, true);
            if (SubmodelMap is IDictionary) {
                DaraModel.ValidateMap(SubmodelMap);
            }
            DaraModel.ValidateRequired("submodelMap", SubmodelMap, true);
            if (Array is IList) {
                DaraModel.ValidateArray(Array);
            }
            if (Array1 is IList) {
                DaraModel.ValidateArray(Array1);
            }
            if (Array2 is IList) {
                DaraModel.ValidateArray(Array2);
            }
            base.Validate();
        }
